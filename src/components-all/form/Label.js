...
import RBFormLabel from 'react-material/FormLabel';
import classNames from 'classnames';
import {materialTextColors} from '../../private/materialColors';
...
const Label = props => {
  ...
  const ismaterialColor = materialTextColors.has(color);
  ...
  const classes = classNames(
    ...
    color && ismaterialColor && `text-${color}`,
  ...
  return (
    <RBFormLabel
      ...
      xxl={xxl}
      className={classes}
      style={!ismaterialColor ? {color: color, ...style} : style}
