...
import RBCarousel from 'react-material/Carousel';

/**
 * Component for creating material carousel.  This component is a slideshow
...
const Carousel = props => {
  ...
  const slides = items.map(item => {
    // note - the default 'd-block w-100' is from the examples in the material docs.
    item.imgClassName =
