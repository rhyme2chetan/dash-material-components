...
import {map} from 'react-material/ElementChildren';
import {omit} from 'ramda';

import {materialColors} from '../../private/materialColors';

/*
 * Bulk of this file is vendored from react-material/src/ProgressBar, but we
...
const Progress = props => {
  ...
  return (
    <ProgressBar
      ...
      barStyle={ismaterialColor ? {} : {backgroundColor: color}}
    >
      {children}
    </ProgressBar>
  );
