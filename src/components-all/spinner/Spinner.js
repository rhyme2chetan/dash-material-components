...
import RBSpinner from 'react-material/Spinner';
import {materialColors} from '../../private/materialColors';

/**
 * Render material style loading spinners using only CSS.
 *
...
const Spinner = props => {
  ...
  const SpinnerDiv = ({style}) => (
    <RBSpinner
      variant={ismaterialColor ? color : null}
      animation={type}
      style={{color: !ismaterialColor && color, ...style}}
...
Spinner.propTypes = {
  ...
  /**
   * Sets the color of the Spinner. Main options are material contextual
