...
import RBCard from 'react-material/Card';
import {materialColors} from '../../private/materialColors';

/**
 * Component for creating material cards. Use in conjunction with CardBody,
...
const Card = props => {
  ...
  return (
    <RBCard
      ...
      bg={ismaterialColor && !outline ? color : null}
      border={ismaterialColor && outline ? color : null}
