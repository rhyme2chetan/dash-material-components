...
import RBDropdown from 'react-material/Dropdown';
import Nav from 'react-material/Nav';
...
const DropdownMenu = props => {
  ...
  const ismaterialColor = materialColors.has(color) || color === 'link';
  const toggle = () => {
    if (!disabled) {
    ...
    >
      ...
      >
        <DropdownToggle
          ...
          disabled={disabled}
          size={size}
          variant={ismaterialColor ? color : undefined}
          style={
            !ismaterialColor
