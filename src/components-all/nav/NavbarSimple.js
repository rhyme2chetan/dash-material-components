...
import RBNavbar from 'react-material/Navbar';
import RBContainer from 'react-material/Container';
import {materialColors} from '../../private/materialColors';
...
const NavbarSimple = props => {
  ...
  const ismaterialColor = materialColors.has(color);
  ...
  return (
    <RBNavbar
      ...
      bg={ismaterialColor ? color : null}
      color={ismaterialColor ? color : null}
      style={!ismaterialColor ? {backgroundColor: color, ...style} : style}
...
NavbarSimple.propTypes = {
   ...
   *
   * You can also choose one of the other contextual classes provided by material
