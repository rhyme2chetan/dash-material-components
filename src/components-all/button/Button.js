...
import RBButton from 'react-material/Button';
import Link from '../../private/Link';

/**
 * A component for creating material buttons with different style options. The
...
const Button = props => {
  ...
  if (useLink) {
    // react-material strips out target prop if tag isn't an anchor element,
